...
export function WhiteKing({ className, style }: PieceProps) {
  return (
...
export function BlackKing({ className, style }: PieceProps) {
  return (
    <svg className={className} style={style} viewBox="0 0 45 45">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export function WhiteQueen({ className, style }: PieceProps) {
  return (
    <svg className={className} style={style} viewBox="0 0 45 45">
...
export function BlackQueen({ className, style }: PieceProps) {
  return (
    <svg className={className} style={style} viewBox="0 0 45 45">
...
export function WhiteRook({ className, style }: PieceProps) {
  return (
    <svg className={className} style={style} viewBox="0 0 45 45">
...
export function BlackRook({ className, style }: PieceProps) {
  return (
    <svg className={className} style={style} viewBox="0 0 45 45">
...
export function WhiteBishop({ className, style }: PieceProps) {
  return (
    <svg className={className} style={style} viewBox="0 0 45 45">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export function BlackBishop({ className, style }: PieceProps) {
  return (
    <svg className={className} style={style} viewBox="0 0 45 45">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export function WhiteKnight({ className, style }: PieceProps) {
  return (
    <svg className={className} style={style} viewBox="0 0 45 45">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export function BlackKnight({ className, style }: PieceProps) {
  return (
    <svg className={className} style={style} viewBox="0 0 45 45">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export function WhitePawn({ className, style }: PieceProps) {
  return (
    <svg className={className} style={style} viewBox="0 0 45 45">
...
export function BlackPawn({ className, style }: PieceProps) {
  return (
    <svg className={className} style={style} viewBox="0 0 45 45">
...
export default function ChessPiece({ pieceType, color, className, style }: ChessPieceProps) {
  ...
  switch (pieceType) {
    case 1: // Pawn
      return isWhite ? <WhitePawn className={className} style={style} /> : <BlackPawn className={className} style={style} />;
    case 2: // Knight
      return isWhite ? <WhiteKnight className={className} style={style} /> : <BlackKnight className={className} style={style} />;
    case 3: // Bishop
      return isWhite ? <WhiteBishop className={className} style={style} /> : <BlackBishop className={className} style={style} />;
    case 4: // Rook
      return isWhite ? <WhiteRook className={className} style={style} /> : <BlackRook className={className} style={style} />;
    case 5: // Queen
      return isWhite ? <WhiteQueen className={className} style={style} /> : <BlackQueen className={className} style={style} />;
    case 6: // King
      return isWhite ? <WhiteKing className={className} style={style} /> : <BlackKing className={className} style={style} />;
    default:
      return null;
  }
}
